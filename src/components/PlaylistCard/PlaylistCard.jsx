    ...
    <div className="video-card playlist-card">
      <Link to={`/playlists/${playlist._id}`} className="video-card-main">
        ...
        <div className="flex flex-column playlist-overlay">
          ...
          <CgPlayList color="white" />
        </div>
      </Link>
      <div style={{ marginTop: "-1rem" }} className="video-card-details">
        <div className="flex-base flex-column title ">
        ...
        <div className="playlist-card-dots video-card-dots flex">
          <button
            ...
            type="button"
          >
            <BsThreeDotsVertical className="icon_svg  flex border_none" />
          </button>
