...
export const PlaylistModal = ({ playlistModal, setPlaylistModal, video }) => {
                  ...
                  playlists.map((playlist) => (
                    <div key={playlist._id}>
                      <input
                        name={playlist.title}
                        type="checkbox"
                        onChange={(e) => checkBoxHandler(e, playlist, video)}
                        checked={
                          isPresentInState(video, playlist?.videos) || ""
                        }
            ...
            {createPlaylist ? (
              ...
              <div className="playlist-add ">
                <button
                  ...
                  type="button"
                  onClick={() => setCreatePlaylist((prev) => !prev)}
                  className="border_none flex-al-center "
                >
